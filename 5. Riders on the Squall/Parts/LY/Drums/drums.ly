...
% chorus
	...
	\repeat "unfold" 2 {
		cymc4 <sn tomfl>8 tomfl tomfl tomfl <sn tomfl> tomfl |
	...
	\repeat "unfold" 2 {
		cymc4 <sn tomfl>8 tomfl tomfl tomfl <sn tomfl> tomfl |
		tomfl tomfl <sn tomfl> tomfl tomfl tomfl <sn tomfl> <sn tomfl> |
		cymr4 <cymr sn> cymr <cymr sn> | cymr <cymr sn> <cymr sn>16 sn sn sn tommh tommh tomfl tomfl |
	}
...
down = \drummode {
	...
	\repeat "unfold" 4 {
		\repeat "unfold" 3 {
			bd4 s bd8 bd s4 |	bd8 bd s bd s bd s4 |
		}
		bd4 s bd8 bd s4 |	bd8 bd s bd s bd s bd |
		bd4 s8 bd s bd s bd | s bd s bd s bd s bd |
		s bd s bd s bd s bd | s bd s bd s bd bd bd |
	}

% chorus
	bd4 s bd8 bd s4 | bd8 bd s4 bd8 bd s4 |
	bd4. bd4. bd4 ~ | bd8 bd4. bd8 bd bd bd |
	\repeat "unfold" 2 {
		bd4 s bd s | bd s bd s |
		bd4 s bd8 bd s bd | s bd s bd bd bd bd4 |
	}
	bd4 s8 bd s bd s bd | s bd s bd s bd s bd |
	s bd s bd s bd s bd | s bd s bd s bd bd bd |
	...
	bd4 s s8 bd s4 | s8 bd s4 s8 bd s4 |
	bd4. bd4. bd4 ~ | bd8 bd4. bd8 bd bd bd |
	bd4 s s2 |
}
